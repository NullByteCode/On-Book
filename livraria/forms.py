...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kargs):
        ...
        self.fields['username'].help_text = '''
            <span class="form-txt text-muted">
                <small>Digite seu nome de usuário.</small>
            </span>
        '''
        ...
        self.fields['password1'].help_text = '''
            <ul class="form-text text-muted smmall">
                <li>Senha deve ter pelo menos 8 caracteres.</li>
                <li>Senha deve ter letras, números, caracteres especiais.</li>
            </ul>
        '''
        ...
        self.fields['password2'].help_text = '''
            <span class="form-txt text-muted">
                <small>As senhas deve ser identicas.</small>
            </span>
        '''
